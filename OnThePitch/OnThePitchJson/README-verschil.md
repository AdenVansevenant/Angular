...
Deze versie haalt de data uit de online API:

```text
https://player-backend-bqcea8cagredcabg.westeurope-01.azurewebsites.net/api
```

De services gebruiken dus echte API-endpoints:
...
Deze versie haalt de data uit lokale JSON-bestanden:
